...
// These three functions are written on Proteus to use the Shift Register.
// With this use, the lighting system is controlled and the pin is saved.
...
void main() {
    ANSELA = 0;               //SET all Pins of PORTA digital
    ANSELB = 0;               //SET all Pins of PORTB digital
    ANSELC = 0;
    ANSELD = 0;               //SET all Pins of PORTD digital
    ANSELE = 0;               //SET all Pins of PORTE digital
    ...
    //ANDROID APP SERIAL TERMINAL MENU
