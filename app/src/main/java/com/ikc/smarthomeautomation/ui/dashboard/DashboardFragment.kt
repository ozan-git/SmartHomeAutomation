package com.ikc.smarthomeautomation.ui.dashboard
...
import com.ikc.smarthomeautomation.databinding.FragmentDashboardBinding
...
class DashboardFragment : Fragment(), ServiceConnection, SerialListener {
...
//    }
    ...
    private fun status(str: String) {
        ...
        Toast.makeText(activity, spn, Toast.LENGTH_SHORT).show()
        binding.receiveText.append(spn)
    }
